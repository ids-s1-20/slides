...
knitr::include_graphics("img/racist_ai_r-1.png")
```


```{r echo=FALSE, out.width="55%"}
knitr::include_graphics("img/racist_ai_r-2.png")
```

.footnote[
.midi[
Thomas Lumley. [How to write a racist AI in R without really trying](https://notstatschat.rbind.io/2018/09/27/how-to-write-a-racist-ai-in-r-without-really-trying/). Biased and Inefficient. 27 September 2018.
]
]
