...
--
- gain insight from data, reproducibly, **using modern programming techniques**
...
- R is also an environment environment for statistical computing and graphics
...
- RStudio is not a requirement for programming with R, but it's the very commonly used by R programmers and data scientists
]
