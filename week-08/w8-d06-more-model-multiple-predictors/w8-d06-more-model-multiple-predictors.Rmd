...
p_main <- ggplot(
  ...
  labs(y = "log_price", title = "Main effects", color = "Artist")
...
p_int <- ggplot(
  ...
  scale_x_continuous(breaks = c(0, 2500, 5000)) +
  geom_line(aes(y = .fitted), size = 1.5) +
  labs(y = "log_price", title = "Interaction effects", color = "Artist")
...
.pull-right-wide[
```{r ref.label="pp-main-int-viz", echo = FALSE, out.width="70%", fig.asp = 0.9}
```
]
